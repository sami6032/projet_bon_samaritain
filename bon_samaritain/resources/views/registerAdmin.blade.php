...
<div class=" bloc1">
  <form action="{{ route('admin.store') }}" style="margin-top:20px" method="POST">
    ...
    <div class="form-floating">
      <input type="password" class="form-control @error('confirmer-password') is-invalid @enderror" name="confirmer_password" id="confirm-password" placeholder="confirm-password" style="border-radius:20px">
